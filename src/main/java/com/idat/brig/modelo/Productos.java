...
public class Productos {
	...
	foreignKey = @ForeignKey(foreignKeyDefinition = "foreing key(id_cliente) reference clientes(id_cliente)")),
	inverseJoinColumns = @JoinColumn(name="id_producto", nullable = false, unique = true,
	foreignKey = @ForeignKey(foreignKeyDefinition = "foreing key(id_producto) reference productos(id_productos)" ))
	)
